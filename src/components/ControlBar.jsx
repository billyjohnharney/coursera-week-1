      ...
      <div className={styles.row}>
        ...
        >
          {PIXEL_SIZES.map(({ value, label }) => (
            <Toggle key={value} value={String(value)} className={styles.toggle} aria-label={`${label} area`}>
              {label}
            </Toggle>
          ))}
        </ToggleGroup>
      ...
      <div className={styles.row}>
        ...
        >
          {UNITS.map(({ value, label }) => (
            <Toggle key={value} value={value} className={styles.toggle} aria-label={`Show ${label} values`}>
              {label}
            </Toggle>
          ))}
        </ToggleGroup>
